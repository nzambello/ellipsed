...
const reset = () => {
  ...
  let text2 = document.querySelectorAll('.text1 p')[0];
...
const uno = () => {
  reset();
  ellipsed('.text p', 1);
  ellipsed(document.querySelectorAll('.text1 p'), 1);
};

const due = () => {
  reset();
  ellipsed('.text p', 2);
  ellipsed(document.querySelectorAll('.text1 p'), 2);
};

const tre = () => {
  reset();
  ellipsed('.text p', 3);
  ellipsed(document.querySelectorAll('.text1 p'), 3);
};

const quattro = () => {
  reset();
  ellipsed('.text p', 4);
  ellipsed(document.querySelectorAll('.text1 p'), 4);
};

const cinque = () => {
  reset();
  ellipsed('.text p', 5);
  ellipsed(document.querySelectorAll('.text1 p'), 5);
};